...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defn operador? [x]
  (contains? #{(symbol ";") (symbol "#") (symbol ",") (symbol "(") (symbol ")") '+ '- '* '/ '= '< '> '<= '>= '?} x))
(operador? (symbol "+"))
(operador? (symbol "%"))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; es-letra?: predicado para determinar si un identificador es una
; letra, por ejemplo:
; user=> (es-letra? \a)
; true
; user=> (es-letra? \1)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; es-valido?: predicado para determinar si un identificador es un
; símbolo válido
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defn es-valido? [x]
  (or (palabra-reservada? x) (operador? x) (every? es-letra? (map char (str x))) (number? x)))
...
(defn anular-invalidos [sentencia]
  (map (fn [x] (if (es-valido? x) x nil)) sentencia))
(anular-invalidos '(IF X & * Y < 12 THEN LET ! X = 0))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; pisar-elemento: TODO
(defn pisar-elemento [nuevo lista]
  (conj (remove (fn [x] (= (first x) (first nuevo))) lista) nuevo))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; concatenar-o-pisar: TODO
(defn concatenar-o-pisar [lista elemento]
  (cond (some (fn [x] (= (first x) (first elemento))) lista) (pisar-elemento elemento lista)
        :else (conj elemento lista)))
...
(defn cargar-linea [linea amb]
  (vec (cons (sort-by first (concatenar-o-pisar (first amb) linea)) (rest amb))))
...
(defn variable-float? [x]
  (cond (symbol? x) (not (or (= (last (str x)) \%) (= (last (str x)) \$)))
        :else false))
(variable-float? 'X)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; encontrar-linea:  TODO
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defn encontrar-linea [nro-linea amb]
  (rest (first (filter (fn [x] (= (first x) nro-linea)) (first amb)))))
(expandir-nexts (encontrar-linea 20 [(list '(10 (PRINT X) (PRINT Y)) '(15 (X = X + 1)) (list 20 (list 'NEXT 'I (symbol ",") 'J))) [10 1] [] [] [] 0 {}]))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
